...
export class MessageService extends BaseService {
   ...
   */
  saveMessage$Response(params: SaveMessage$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseString>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveMessage(params: SaveMessage$Params, context?: HttpContext): Observable<ApiResponseString> {
   ...
   */
  setMessageToSeen$Response(params: SetMessageToSeen$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseString>> {
   ...
   * This method doesn't expect any request body.
   */
  setMessageToSeen(params: SetMessageToSeen$Params, context?: HttpContext): Observable<ApiResponseString> {
   ...
   */
  uploadMedia$Response(params: UploadMedia$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseString>> {
   ...
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploadMedia(params: UploadMedia$Params, context?: HttpContext): Observable<ApiResponseString> {
