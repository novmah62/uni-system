...
export function setMessageToSeen(http: HttpClient, rootUrl: string, params: SetMessageToSeen$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseString>> {
